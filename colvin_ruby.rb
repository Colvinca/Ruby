...
#
# Due Date: Febraury 21, before class.
#
...
# 4. Display "Odd" if the number of character in the title is an odd number,
#    Display "Even" if the number of characters in the title is an even number.
#
